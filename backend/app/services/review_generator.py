...
class LiteratureReviewGenerator:
    ...
    def configure_llm(self, api_key: str, model: str, base_url: Optional[str] = None):
        ...
        configure_llm_client(self, api_key, model, base_url or "")

    async def generate(
        self,
        references: List[Reference],
        graph_structure: Optional[GraphData] = None,
        style: str = "academic",
        ...
        try:
            ...
            response = await self.llm_client.chat.completions.create(
                ...
                messages=[
                    {
                        "role": "system",
                        "content": "你是一位专业的学术论文写作助手，擅长撰写高质量的文献综述。",
                    },
...
""")
        ...
        style_instruction = STYLE_INSTRUCTIONS.get(
            style, STYLE_INSTRUCTIONS["academic"]
        )
    ...
    def _build_graph_section(
        self, references: List[Reference], graph_structure: Optional[GraphData]
    ) -> str:
    ...
    async def refine_section(
        self, section_content: str, instruction: str, references: List[Reference]
    ) -> str:
        """
